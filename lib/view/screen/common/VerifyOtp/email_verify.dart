      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 22,),
            CommonText(text: "Check your email",fontSize: 24,fontWeight: FontWeight.w600,color: AppColors.white,),
            SizedBox(height: 7,),
            CommonText(text: "We sent a password reset link to user***@example.com",fontSize: 16,fontWeight: FontWeight.w500,color: AppColors.white,),
            SizedBox(height: 25,),
            SizedBox(
              height: 55,
              width: 300,
